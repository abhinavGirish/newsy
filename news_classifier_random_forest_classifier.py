...
for sen in range(0, len(X)):
    ...
    if doc:
        ...
        Y_modified = Y_modified.append({'clickbait_category': Y[sen]}, ignore_index=True)
...
x_train, x_test, y_train, y_test = train_test_split(X_dense, Y_modified['clickbait_category'], test_size = 0.2)
